...
10. **Next up (unprioritized):** Technical indicators beyond pandas-ta; production concerns (monitoring/alerting, deeper history via a paid data source since Kraken's public OHLC caps at ~720 candles); consider whether any tested config is actually worth paper-trading given none has shown a robust edge so far
